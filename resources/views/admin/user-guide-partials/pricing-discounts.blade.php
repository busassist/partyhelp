<section id="pricing-discounts" class="scroll-mt-8">
    ...
    <p><strong>Manage System Pricing → Discount Settings</strong> define <strong>time-based discounts</strong>: after a configured time (hours and minutes) since distribution, apply a discount percentage to the lead’s price. For example: “After 24 hours 0 minutes, 10% off”; “After 48 hours, 20% off.” You can also set short windows for testing (e.g. 0 hours 2 minutes). The scheduled job <strong>Process Lead Discounts</strong> runs every hour, finds distributed or partially fulfilled leads that have passed each rule’s time threshold, and updates <strong>discount_percent</strong> and <strong>current_price</strong> (current_price = base_price × (1 − discount_percent/100)). Optionally, <strong>resend notification</strong> can re-notify matched venues that the lead is now cheaper. Changes you save on the Discount Settings screen are used automatically on the next run.</p>
