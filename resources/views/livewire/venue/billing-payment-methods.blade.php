<div class="space-y-6 w-full max-w-full">
    <div class="flex flex-wrap items-stretch gap-6">
        <div class="flex min-w-[260px] flex-1 flex-col rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800/50">
            ...
            @endif
            <form action="{{ route('venue.billing.create-setup-session') }}" method="GET" class="mt-auto" style="padding-top: 10px;">
                <button
                    type="submit"
        ...
        <form wire:submit="updateAutoTopup" class="flex min-w-[260px] flex-1 flex-col rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800/50">
            <h3 class="text-base font-semibold text-gray-900 dark:text-white">Auto top-up</h3>
            <div class="flex flex-1 flex-col space-y-5 pt-2">
