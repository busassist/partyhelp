    ...
    <form wire:submit="updateAutoTopup" class="space-y-5 rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800/50">
        ...
        <div class="space-y-2">
            ...
            <select
                ...
                class="block w-full max-w-xs rounded-lg border-gray-300 shadow-sm focus:border-[#7c3aed] focus:ring-[#7c3aed] dark:border-gray-600 dark:bg-gray-700 dark:text-white"
            >
