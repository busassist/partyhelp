{{-- Lead Opportunity with discount – Venue, +24h (10%) or +48h (20%). Same structure as lead-opportunity with discount banner. --}}
@php
...
<p style="font-size:18px;font-weight:600;color:#fff;margin-top:16px;text-align:center;">New lead – discounted</p>
</td></tr>
<tr><td style="padding:0 24px 24px;">
<p style="font-size:15px;color:#cbd5e1;line-height:1.6;margin:0 0 12px;">{!! $introText !!}</p>
<table cellpadding="0" cellspacing="0" border="0" width="100%" style="background:rgba(168,85,247,0.15);border:1px solid rgba(168,85,247,0.3);border-radius:12px;"><tr><td style="padding:16px 20px;">
<p style="font-size:15px;font-weight:600;color:#a855f7;margin:0;">{!! $discountIntroText !!}</p>
</td></tr></table>
<table cellpadding="0" cellspacing="0" border="0" width="100%" style="background:linear-gradient(145deg,#1e0f3d,#160b2e);border:1px solid rgba(255,255,255,0.05);border-radius:16px;margin-top:16px;">
