...
class EmailTemplateSeeder extends Seeder
{
    public function run(): void
    {
        $templates = [
            ...
            [
                'key' => 'lead_opportunity_10pct',
                'name' => 'Lead Opportunity (10% discount)',
                'subject' => 'New {{occasion}} Lead - {{suburb}} - 10% off - ${{price}}',
                'content_slots' => [
                    'intro_text' => 'This lead is still available – now at 10% off for the next 24 hours.',
                    'discount_intro_text' => 'This lead is now 10% off. Purchase to receive full customer details.',
                    'cta_button_label' => 'Purchase This Lead - ${{price}}',
                    'footer_balance_text' => 'Your credit balance: ${{creditBalance}}',
                    'topup_link_text' => 'Top up credits',
                ],
            ...
            [
                'key' => 'lead_opportunity_20pct',
                'name' => 'Lead Opportunity (20% discount)',
                'subject' => 'New {{occasion}} Lead - {{suburb}} - 20% off - ${{price}}',
                'content_slots' => [
                    'intro_text' => 'This lead is still available – now at 20% off until the lead window closes.',
                    'discount_intro_text' => 'This lead is now 20% off. Purchase to receive full customer details.',
                    'cta_button_label' => 'Purchase This Lead - ${{price}}',
                    'footer_balance_text' => 'Your credit balance: ${{creditBalance}}',
                    'topup_link_text' => 'Top up credits',
                ],
